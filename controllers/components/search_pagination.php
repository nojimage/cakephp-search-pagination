...
{
  var $_controller;
  var $_helperName = 'SearchPagination.SearchPagination';
   ...
   */
  function setup($searchModel, $default=array(), $useModel=true)
  {
   ...
   * @return array
   */
  function __getDataFromURL($searchModel)
  {
